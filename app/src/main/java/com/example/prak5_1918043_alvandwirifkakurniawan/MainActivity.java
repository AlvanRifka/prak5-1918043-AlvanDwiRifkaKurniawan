package com.example.prak5_1918043_alvandwirifkakurniawan;
...
public class MainActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    private void updateTimeText(Calendar c){
        ...
        timeText += DateFormat.getTimeInstance(DateFormat.SHORT).format(c.getTime()); mTextView.setText(timeText);
    }
    //memulai alarm
